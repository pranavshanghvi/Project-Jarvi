...
function answer(q, live){
  ...
  if(live && canLive() && wantLive){
    ...
    runLive(q, {section: near ? near.item : null}, box, "", alsoWritten(written));
    return;
  }
  if(!weak){
...
document.addEventListener("click", ev => {
  const t = ev.target.closest("[data-v],[data-read],[data-go],[data-lvl],[data-setlvl],[data-settheme],[data-setlive],[data-live],[data-ask],#backidx,#resetprof,#clearcache,#runqueued,#flightgo,#testgo");
  if(!t) return;
